  ...
  module Rack
    ...
    class CorsAccessControl
      ...
      def access_control_headers(env)
        ...
        client_headers_to_approve = env['HTTP_ACCESS_CONTROL_REQUEST_HEADERS']
        cors_headers['Access-Control-Allow-Headers'] += ",#{client_headers_to_approve}" if client_headers_to_approve.present?
        cors_headers
      end
